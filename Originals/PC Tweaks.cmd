...
echo "GlobalMaxTcpWindowSize"=dword:%RWIN%
echo "MaxConnectionsPer1_0Server"=dword:%MAXCONNECTIONS%
echo "MaxConnectionsPerServer"=dword:%MAXCONNECTIONS%
echo "MaxFreeTcbs"=dword:0000ffff
echo "MaxHashTableSize"=dword:00010000
echo "MaxUserPort"=dword:0000fffe
echo "NumTcbTablePartitions"=dword:%TABLEPART%
...
echo "SystemResponsiveness"=dword:%SYSRES%
...
echo "LargeSystemCache"=dword:%LARGECACHE%
