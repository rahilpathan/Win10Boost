...
reg add "HKLM\SOFTWARE\Microsoft\WcmSvc\wifinetworkmanager\features" /v FeatureStates /t REG_SZ /d 828 /f
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DeviceHealthAttestationService" /v DisableSendGenericDriverNotFoundToWER /t REG_DWORD /d 0 /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\DeviceHealthAttestationService" /v EnableDeviceHealthAttestationService /t REG_DWORD /d 0 /f
