...
powershell Invoke-WebRequest -Uri https://raw.githubusercontent.com/rahilpathan/Win10Boost/main/Other%20Tricks/PP/1usmus.pow -OutFile "%HOMEPATH%\Documents\Type1.pow"
