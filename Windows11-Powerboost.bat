...
echo Optimizing multimedia settings...
...
echo Optimizing display post-processing...
...
echo Setting DirectoryCacheLifetime...
...
echo Setting folder type...
reg add "HKCU\SOFTWARE\Classes\Local Settings\Software\Microsoft\Windows\Shell\Bags\AllFolders\Shell" /v "FolderType" /t REG_SZ /d "NotSpecified" /f

:: Disable unnecessary services
echo Disabling unnecessary services...
:: WARNING: Disabling some services (e.g., wuauserv, Windows Defender) may affect security or functionality
for %%s in (
...
:: WARNING: Disabling telemetry may limit Microsoft's ability to provide tailored updates
...
:: WARNING: Disabling Windows Defender may leave your system vulnerable to malware
...
:: WARNING: Disabling updates may prevent critical security patches
...
:: Set hard disk idle timeout to 0 seconds
powercfg /setacvalueindex SCHEME_CURRENT SUB_DISK DISKIDLE 0

:: Set hard disk spin-down timeout to 0 seconds
powercfg /setacvalueindex SCHEME_CURRENT SUB_DISK DISKSPINDOWN 0

:: Set PCI Express link state power management to 0 (performance mode)
powercfg /setacvalueindex SCHEME_CURRENT SUB_PCIEXPRESS ASPM 0

:: Set USB selective suspend timeout to 0 seconds
powercfg /setacvalueindex SCHEME_CURRENT SUB_USB USBSUSPEND 0

:: CPU Parking tweaks
powercfg /setacvalueindex SCHEME_CURRENT SUB_PROCESSOR CPUPARKING 0
powercfg /setacvalueindex SCHEME_CURRENT SUB_PROCESSOR CPUPARKINGMAX 0

:: Other potential tweaks
powercfg /setacvalueindex SCHEME_CURRENT SUB_PROCESSOR IDLETIMERS 0
powercfg /setacvalueindex SCHEME_CURRENT SUB_PCIEXPRESS PCIEBUSMASTER 0
powercfg /setacvalueindex SCHEME_CURRENT SUB_PCIEXPRESS PCIELINKSTATE 0
